...
box on;
%glcuose
plot(mu,glc,'-','Marker','.','MarkerSize',4,'LineWidth',0.5,'Color',color_glc);
...
box on;
%acetate
plot(mu,ac,'-','Marker','.','MarkerSize',4,'LineWidth',0.5,'Color',color_ac);
...
box on;
%formate
plot(mu,form,'-','Marker','.','MarkerSize',4,'LineWidth',0.5,'Color',color_form);
...
box on;
%lactate
plot(mu,lac,'-','Marker','.','MarkerSize',4,'LineWidth',0.5,'Color',color_lac);
...
plot(mu,glcT_saturation,'-','Marker','.','MarkerSize',4,'LineWidth',0.5,'Color',color_glcT);
% exp_mumax = 0.71;
% exp_K = 0.019*1000;
% x = 0:1:3000;
...
box on;
%inavtive enzyme
plot(mu,total_inactive_enzyme,'-','Marker','.','MarkerSize',4,'LineWidth',0.5,'Color',color_inactE);
