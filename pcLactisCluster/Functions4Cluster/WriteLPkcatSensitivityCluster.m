%% WriteLPkcatSensitivityCluster
% This is for sensitivity analysis of kcats

function fileName = WriteLPkcatSensitivityCluster(model,mu,f,osenseStr,rxnID,factor_k,...
...
load('kcat_M_Cluster.mat');
m_enzyme = kcat_M.gpr;
m_kcat = kcat_M.kcat;

[~, ~, k_raw_e] = xlsread('kcat_E_Cluster.xlsx','E');
