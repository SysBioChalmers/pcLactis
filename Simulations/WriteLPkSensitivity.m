%% WriteLPkSensitivity
% This is for sensitivity analysis of catalytic rates

function fileName = WriteLPkSensitivity(model,mu,f,osenseStr,rxnID,factor_k,...
...
% Kinetic parameters
k = SetParametersSensitivity(mu,ID,fold);
