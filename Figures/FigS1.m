...
b(1).FaceColor = [228,26,28]/255;
b(2).FaceColor = [55,126,184]/255;
b(3).FaceColor = [255,255,51]/255;
b(4).FaceColor = [152,78,163]/255;
b(5).FaceColor = [255,127,0]/255;
b(6).FaceColor = [77,175,74]/255;
b(7).FaceColor = [166,86,40]/255;
b(8).FaceColor = [247,129,191]/255;
b(9).FaceColor = [153,153,153]/255;
