...
% [~,~,f_enzyme_inact,~] = CheckInactiveEnzyme(model,fluxes_simulated_without_sf(:,1),factor_k);
% lac2 = fluxes_simulated_without_sf(strcmp(model.rxns,'R_M_EX_lac__L_e'),:);
% arg2 = -fluxes_simulated_without_sf(strcmp(model.rxns,'R_M_EX_arg__L_e'),:);

cd Results/;
save('Sglc_fluxes.mat','fluxes_simulated_without_sf');
save('Sglc_result.mat','glc_conc_without_sf');
cd ../;
