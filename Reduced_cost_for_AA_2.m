...
for i = 1:length(selected_points)
    ...
    % Estimate reference state using the new AA uptakes and growth rate
        ...
        mu_ref_new = solME_full(strcmp(model_tmp.rxns,'R_biomass_dilution'),1);
        solME_full_ref = solME_full;
    ...
    for j = 1:length(aa_list)
        ...
        if strcmp(solME_status,'optimal')
            ...
            res_tmp = [mu_ref_new;mu_low;-aaref;-aalb;-solME_full(strcmp(model_tmp.rxns,aarxnid),1)];
...
cd Results/;
save('RcAA2_fluxes.mat','fluxes_rcAA');
save('RcAA2_reffluxes.mat','fluxes_ref');
save('RcAA2_result.mat','result_rcAA');
cd ../;
