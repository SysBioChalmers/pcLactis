...
ylabel('Flux','FontSize',8,'FontName','Helvetica');
xlabel('Growth rate (/h)','FontSize',8,'FontName','Helvetica');
title('Glucose','FontSize',8,'FontName','Helvetica');
...
ylabel('Flux','FontSize',8,'FontName','Helvetica');
xlabel('Growth rate (/h)','FontSize',8,'FontName','Helvetica');
title('Acetate','FontSize',8,'FontName','Helvetica');
...
ylabel('Flux','FontSize',8,'FontName','Helvetica');
xlabel('Growth rate (/h)','FontSize',8,'FontName','Helvetica');
title('Ethanol','FontSize',8,'FontName','Helvetica');
...
ylabel('Flux','FontSize',8,'FontName','Helvetica');
xlabel('Growth rate (/h)','FontSize',8,'FontName','Helvetica');
title('Formate','FontSize',8,'FontName','Helvetica');
...
ylabel('Flux','FontSize',8,'FontName','Helvetica');
xlabel('Growth rate (/h)','FontSize',8,'FontName','Helvetica');
title('Lactate','FontSize',8,'FontName','Helvetica');
...
ylabel('Flux','FontSize',8,'FontName','Helvetica');
xlabel('Growth rate (/h)','FontSize',8,'FontName','Helvetica');
title('Arginine','FontSize',8,'FontName','Helvetica');
...
set(gca,'FontSize',12,'FontName','Helvetica');
xlabel('Growth rate (/h)','FontSize',14,'FontName','Helvetica');
ylabel(['Inactive enzyme',char(13,10)','(g/gCDW)'],'FontSize',14,'FontName','Helvetica');
