%% Note
% Running the current code you will get infeasible solution.
% Two ways you can get feasible solution.
% 1. Increase growth rate from D = 0.3 to D = 0.33, (Line 79)
% which is just the case that you mentioned in the email.
% 2. Keep using D = 0.3, if you change 
% "--real:fpfeastol=1e-6 --real:fpopttol=1e-6" (Line 94)
% to "--real:fpfeastol=1e-3 --real:fpopttol=1e-3" or the default 
% "--real:fpfeastol=1e-9 --real:fpopttol=1e-9" you will get feasible soultion.
...
factor_glc_mid = 0.3;%saturation factor of glucose transporter
