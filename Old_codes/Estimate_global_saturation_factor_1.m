%% Estimate a global saturation factor 1.

% Timing: ~ 4300 s

% Do not consider glucose transporter. The estimated sf is just used for
% the simulations without minimizing glucose concentration.
...
cd Results/;
save('Egsf1_result.mat','global_saturation_factor_list');
save('Egsf1_fluxes.mat','fluxes_global_saturation_factor_changed');
cd ../;
clear;
