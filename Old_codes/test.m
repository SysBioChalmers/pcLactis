...
% yatp_3 = 3;
yatp_3 = 1.67;
protein_efficiency_1 = 456.073; % 456.073
protein_efficiency_2 = 896.77; % 896.77
...
box on;
hold on;
plot(mu_list,flux(1,:)+flux(2,:),'-','LineWidth',1.5,'Color',[247,129,191]/255);
% ylim([0 49]);
xlim([0 0.7]);
set(gca,'FontSize',6,'FontName','Helvetica');
title('Glucose uptake','FontSize',7,'FontName','Helvetica');

subplot(5,1,2);
box on;
hold on;
plot(mu_list,flux(1,:),'-','LineWidth',1.5,'Color',color_ma);
% ylim([0 12]);
xlim([0 0.7]);
set(gca,'FontSize',6,'FontName','Helvetica');
...
box on;
hold on;
plot(mu_list,flux(2,:),'-','LineWidth',1.5,'Color',color_la);
% ylim([0 25]);
xlim([0 0.7]);
set(gca,'FontSize',6,'FontName','Helvetica');
...
set(gcf,'position',[200 600 100 400]);
